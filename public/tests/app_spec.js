describe('LearnJS', function () {
    ...
    describe('with DynamoDB', function () {
        ...
        describe('saveAnswer', function () {
            ...
            it('resubmits the request on retry', function () {
                ...
                expect(learnjs.sendAwsRequest.calls.first().args[1]()).toEqual('promise');
                expect(learnjs.saveAnswer).toHaveBeenCalledWith(1, {
                    answer: 'false'
                });
            });
        });
    ...
    describe('awsRefresh', function () {
        ...
        beforeEach(function () {
            ...
            fakeCreds.refresh.and.callFake(function (cb) {
                cb(callbackArg);
            });
        });
    ...
    describe('googleSignIn callback', function () {
        ...
        beforeEach(function () {
            ...
            user.getAuthResponse.and.returnValue({
                id_token: 'GOOGLE_ID'
            });
        ...
        describe('refresh', function () {
            ...
            beforeEach(function () {
                ...
                updateSpy.getAuthResponse.and.returnValue({
                    id_token: "GOOGLE_ID"
                });
            ...
            it('does not re-prompt for consent when refreshing the token in', function (done) {
                learnjs.identity.done(function (identity) {
                    identity.refresh().then(function () {
                        expect(instanceSpy.signIn).toHaveBeenCalledWith({
                            prompt: 'login'
                        });
                        done();
                    });
